...
create table history_exam_word (id bigint not null generated always as identity, en varchar(1000), zh varchar(1000), type varchar(100),source varchar(100),examId bigint,status smallint)
